...
namespace MOM
{
    ...
    class GameControl : GraphicsDeviceControl
    {
        ...
        const Int32 ScreenX = 640;
        const Int32 ScreenY = 400;
        ...
        protected override void Initialize()
        {
            try
            {
                ...
                textureMainTitle = content.Load<Texture2D>("screen_maintitle");
            }
            catch (Exception ex)
            {
        ...
        protected override void Draw()
        {
            ...
            spriteBatch.Draw(textureMainTitle, new Rectangle(0, 0, ScreenX, ScreenY), Color.White);
            spriteBatch.End();
